...
from utils import interpolate_array_nan, add_event_markers_to_data_array, generate_epochs, \
...
varjoEyetracking_preset_path = 'D:/PycharmProjects/RealityNavigation/Presets/LSLPresets/VarjoEyeDataComplete.json'
