...
x_i_dt_head, y_i_dt_head, epochs, event_ids, _ = rena_epochs_to_class_samples_rdf(rdf, event_names, event_filters, data_type='eeg', rebalance=True, participant=participant, session=session)
