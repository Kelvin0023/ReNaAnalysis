...
criterion, last_activation = mmarray.get_label_encoder_criterion_for_model(best_model, device=device, include_metainfo=True)
test_iterator = mmarray.get_test_dataloader(batch_size=batch_size, encode_y=False, return_metainfo=True, device=device)
