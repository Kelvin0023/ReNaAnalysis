...
raw_epoch = mne.Epochs(raw, event_groups, tmin=-1.5, tmax=25, verbose=True, picks=['hbo', 'hbr'], event_id=event_id, preload=True)
filtered_raw_epoch = mne.Epochs(filtered_raw, event_groups, tmin=-1.5, tmax=25, verbose=True, picks=['hbo', 'hbr'], event_id=event_id, preload=True)

visualize_eeg_epochs(filtered_raw_epoch, event_id, event_color, picks=channel_names, tmin_vis=-1.5, tmax_vis=24, title='', out_dir=None, verbose='INFO', fig_size=(12.8, 7.2),
                     is_plot_timeseries=True)
