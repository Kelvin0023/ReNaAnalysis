...
# x, y, _, _ = epochs_to_class_samples(rdf, event_names, event_filters, data_type='eeg', rebalance=True, participant='1', session=1)

# pickle.dump(x, open('x_p1_s1.p', 'wb'))
# pickle.dump(y, open('y_p1_s1.p', 'wb'))
