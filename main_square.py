...
if is_regenerate_epochs:
    x, y, _, _ = rena_epochs_to_class_samples_rdf(rdf, event_names, event_filters, data_type='both', rebalance=True, participant='1', session=0, plots='full', force_square=True)
